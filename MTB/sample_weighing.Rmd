...
df= read.csv(file ='C:/Users/tsb7592/Downloads/NIHTB_demoFinal_April.csv') # tianchu's path
...
outsave <- anesrake(targets, adult2, caseid=adult2$FinalPIN, verbose=TRUE, pctlim = 0.01,cap=4 )
...
outsave_ak <- anesrake(targets, kids, caseid=kids$FinalPIN, verbose=TRUE, pctlim = 0.01,cap=4)

kids$weights <- outsave_ak$weightvec


write.csv(kids,"C:/Users/tsb7592/Downloads/kids_April.csv", row.names = FALSE)
```
...
outsave_ab <- anesrake(targets, adult, caseid=adult$FinalPIN, verbose=TRUE, cap=4,pctlim = 0.01)

adult2$weights.7b <- outsave_ab$weightvec
write.csv(adult2,"C:/Users/tsb7592/Downloads/adults_April.csv", row.names = FALSE)
```

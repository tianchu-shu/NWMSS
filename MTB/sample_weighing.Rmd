...
parentedu <-c("less than high school graduate","high school graduate","some college",
...
names(rrtarg) <- c('1-Non-Hispanic Asian','1-Non-Hispanic Black', '1-Any Hispanic',
       '1-Non-Hispanic Other','1-Non-Hispanic White',
       '2-Non-Hispanic Asian', '2-Non-Hispanic Black', '2-Any Hispanic', 
       '2-Non-Hispanic Other', '2-Non-Hispanic White', 
       '3-Non-Hispanic Asian', '3-Non-Hispanic Black',
       '3-Any Hispanic', '3-Non-Hispanic Other', '3-Non-Hispanic White', 
       '4-Non-Hispanic Asian','4-Non-Hispanic Black','4-Any Hispanic',
       '4-Non-Hispanic Other','4-Non-Hispanic White')
...
middleadw <- Calc_weights(mtarget,middleadult, selfedu)
...
olderadw <- Calc_weights(otarget, olderadult, selfedu)
